...
class CausalTFNetSeparator(nn.Module):
    ...
    def __init__(self, args):
        ...
        window_eps = float(args.network_audio.get("causal_window_eps", 1e-4))
        if window_eps > 0:
        ...
        self.streaming_train = bool(args.network_audio.get("streaming_train", False))
        self.streaming_emit_len = int(args.network_audio.get("streaming_emit_len", 0))
        self.streaming_left_len = int(args.network_audio.get("streaming_left_len", 0))
